...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.preferred_email'
        db.delete_column(u'social_userprofile', 'preferred_email')

        # Adding field 'UserProfile.status'
        db.add_column(u'social_userprofile', 'status',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.preferred_email'
        db.add_column(u'social_userprofile', 'preferred_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.status'
        db.delete_column(u'social_userprofile', 'status')
